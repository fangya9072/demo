...
class LocationView extends React.Component {
  ...
  updateLocationName(coordinate) {
    this.props.updateLocationName(coordinate);
  }
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity style={[styles.currentLocBtn, {backgroundColor: 'lightgray'}]} onPress={this._getCurrentLocation}>
          <MaterialIcons name={'my-location'} color={'black'} size={25}/>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.actionButton, this.props.actionButtonStyle]}
          onPress={() => {
            this.props.onLocationSelect({...this.state.region, address: this._input.getAddress()});
            ...
            this.updateLocationName({latitude: this.state.region.latitude, longitude: this.state.region.longitude})
          }}
        >
          <View>
